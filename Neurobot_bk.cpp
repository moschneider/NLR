...
const int max_tabuleiros = 20; // numero maximo de tabuleiros tratados
...
MENU principal, labirinto, vision;

BOOL todos_ok;

int total_acertos, total_giros, x_start;

float taxa_erro;

///////////////////////////////////////////////////////
// Prototipos de funcoes                             //
// (Descricao das funcoes se encontra na implementa- //
// cao de cada uma abaixo)                           //
///////////////////////////////////////////////////////
...
BOOL caixa_mensagem(int,int,int,char*);

void tecla(void);

int escolha(int,int,MENU);
...
TABULEIRO init_tabuleiro(int);

CAMINHO init_caminho(void);

void mostra_tabuleiro(TABULEIRO,BOOL,BOOL);

TABULEIRO estabelece_visao(TABULEIRO);

TABULEIRO estabelece_giros(TABULEIRO);

int conta_elementos(CAMINHO);

int calcula_distancia(CAMINHO);

CAMINHO algoritmo_simbolico(XY,TABULEIRO,CAMINHO);

MAPA init_mapa();

void execute_caminho(TABULEIRO,CAMINHO);

void aprende_caminho(TABULEIRO,CAMINHO);
...
void dump_rede(REDE_NEURAL,BOOL);

REDE_NEURAL feedforward(TABULEIRO,REDE_NEURAL);

REDE_NEURAL backpropagation(REDE_NEURAL,SAIDA);

SAIDA extrai_saidas(REDE_NEURAL);

MAPA cria_mapa_das_saidas(SAIDA);

SAIDA cria_saidas_do_mapa(MAPA);

void modificar_tabuleiro(void);

void mostra_tabuleiros(void);

void mostra_mapa(MAPA);

void mostra_saida(SAIDA);

SAIDA gera_saida_para_teste(int,int);

void testa_teclado(void);

int gera_codigo_visao(TABULEIRO);

int gera_codigo_obstaculos(TABULEIRO);
...
void init_menus(void)
{
	...
	labirinto.titulo=" ESCOLHA LABIRINTO ";
	labirinto.item[0]=" Modificar Labirinto 00 ";
	labirinto.item[1]=" Modificar Labirinto 01  ";
	labirinto.item[2]=" Modificar Labirinto 02  ";
	labirinto.item[3]=" Modificar Labirinto 03  ";
	labirinto.item[4]=" Modificar Labirinto 04  ";
	labirinto.item[5]=" Modificar Labirinto 05  ";
	labirinto.item[6]=" Modificar Labirinto 06  ";
	labirinto.item[7]=" Modificar Labirinto 07  ";
	labirinto.item[8]=" Modificar Labirinto 08  ";
	labirinto.item[9]=" Modificar Labirinto 09  ";
	labirinto.item[10]=" Modificar Labirinto 10 ";
	labirinto.item[11]=" Modificar Labirinto 11 ";
	labirinto.item[12]=NULL;
...
void informacoes_gerais(void)
{
	...
	printf("Sao analisados 11 labirintos por um algoritmo simbolico, que fornece");
...
*/
			...
			data[11].elemento[7][1]=obstaculo;
...
void aprende_caminhos(void)
{
	...
	while(!kbhit() && todos_ok==False)
	{
		...
		printf("Total acertos  : %i / %i",total_acertos,total_giros);
...
void modificar_tabuleiro(void)
{
	...
	tabuleiro_nr=escolha(0,10,labirinto);
	...
	if(caixa_mensagem(pergunta,0,21," Substituir tabuleiro original? ")==True)
		data[tabuleiro_nr]=tabuleiro_local;
}
